...
public:
  ...
  void addiu(const string &r1, const string &r2, int imm) {
    os << "addi " << reg[r1] << ", " << reg[r2] << ", " << imm << endl;
  }
  ...
  void mult(const string &r1, const string &r2, const string &r3) {
    os << "mul " << reg[r1] << ", " << reg[r2] << ", " << reg[r3] << endl;
  }
  void div(const string &r1, const string &r2, const string &r3) {
    os << "div " << reg[r1] << ", " << reg[r2] << ", " << reg[r3] << endl;
  }
  void rem(const string &r1, const string &r2, const string &r3) {
    os << "rem " << reg[r1] << ", " << reg[r2] << ", " << reg[r3] << endl;
  }
  ...
  void bgt(const string &r1, const string &r2, const string &label) {
    os << "blt " << reg[r2] << ", " << reg[r1] << ", " << label << endl;
  }
  void ble(const string &r1, const string &r2, const string &label) {
    os << "bge " << reg[r2] << ", " << reg[r1] << ", " << label << endl;
  }
   ...
   */
  void b(const string &label) { os << "jal zero, " << label << endl; }
  void jal(const string &label) { os << "jal ra, " << label << endl; }
  void jr(const string &r1) { os << "jalr zero, " << reg[r1] <<  ", 0" << endl; }
